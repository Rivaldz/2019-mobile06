...
public class BrocaIndexFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText heightText = view.findViewById(R.id.text_plane);
            ...
            public void onClick(View view) {
                if (mListener != null){
                    ...
                    if ((checkedID != -1 ) && !TextUtils.isEmpty(heightString)){
                        ...
                        mListener.onCalculateBrocaIndexClickerd(brocaIndex.getIndex());
                    } else {
                        Toast.makeText(getActivity(), "Please select gender input your height", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//        void onFragmentInteraction(Uri uri);
        void onCalculateBrocaIndexClickerd(float index);
    }
}
